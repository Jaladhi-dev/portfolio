...
const ProjectCard = ({ project }: { project: any }) => {
    ...
    return (
        <div
            ...
            onClick={() => trackEvent({ action: 'click_project_card', category: 'Projects Section', label: project.title })}
        >
                ...
                {project.links && project.links.map((link: any, i: number) => (
                    <a
                        ...
                        onClick={(e) => {
                            ...
                            trackEvent({ action: 'click_project_link', category: 'Projects Section', label: `${project.title} - ${link.label}` })
                        }}
                    >
                        {link.icon === 'apple' ? (
